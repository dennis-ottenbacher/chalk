...
async function runMigration() {
    console.log('Attemping to apply Transaction migration to local database...')
    ...
    const migrationPath = path.join(
        ...
        'supabase',
        'migrations',
        '20260129_add_organization_id_to_transactions.sql'
    )
    let sqlContent = ''
    ...
    try {
        ...
        console.log('Transactions table should now have organization_id.')
    } catch (err) {
